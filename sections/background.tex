...
\label{thm:bg-id}
Under \cref{cond:c1,cond:c2,cond:c3} and standard regularity, $\theta$
is identifiable iff the augmented candidate-set matrix $\tilde{C}
\in \{0,1\}^{n \times m}$ has full column rank $m$.
\end{theorem}
